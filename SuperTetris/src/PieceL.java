...
public class PieceL extends Piece {
    ...
    public PieceL() {
        super();
        this._grillePiece[0][0] = 4;
        this._grillePiece[0][1] = 4;
        this._grillePiece[1][1] = 4;
        this._grillePiece[2][1] = 4;
    }
    ...
    public void Rotation() {
        switch (this._position) {
            case 1:
                ...
                this._grillePiece[0][2] = 4;
                this._grillePiece[1][2] = 4;
                this._grillePiece[1][1] = 4;
                this._grillePiece[1][0] = 4;
                break;
            case 2:
                this._position = 3;
